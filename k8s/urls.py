...
urlpatterns = [
    ...
    url(r'^init_ceph$', iviews.init_ceph, name='init_ceph'),
    url(r'^init_ceph_api$', iviews.init_ceph_api, name='init_ceph_api'),
    url(r'^init_publ$', iviews.init_publ, name='init_publ'),
    url(r'^init_publ_api$', iviews.init_publ_api, name='init_publ_api'),
